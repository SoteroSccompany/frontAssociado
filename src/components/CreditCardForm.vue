                            ...
                            <div class="card-item__wrapper">
                                ...
                                <div class="card-item__content">
                                    <label for="cardName" class="card-item__info" ref="cardName">
                                        <div class="card-item__holder">Nome do cartão</div>
                                        <transition name="slide-fade-up">
                                            <div class="card-item__name" v-if="cardName.length" key="1">
                                                <transition-group name="slide-fade-right">
                                                    <span v-for="(n, $index) in cardName.replace(/\s\s+/g, ' ')"
                                                        v-bind:key="$index + 1">
                                                        <span class="card-item__nameItem"
                                                            v-if="$index === $index">{{n}}</span>
                                                    </span>
                                                </transition-group>
                                            </div>
                ...
                <div class="card-form__inner">
                    <div class="card-input">
                        ...
                        <input type="text" id="cardNumber" class="card-input__input" v-model="cardNumber"
                            v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off">
                    </div>
                    <div class="card-input">
                        <label for="cardName" class="card-input__label">Nome do cartão</label>
                    ...
                    <div class="card-input">
                        <label for="cardName" class="card-input__label">Sobrenome do cartão</label>
                        <input type="text" id="cardName" class="card-input__input" v-model="cardLastName"
                            autocomplete="off">
                    </div>
                    ...
                    <button class="card-form__button" @click="log()">
                        Enviar
                    </button>
                </div>
            </div>
...
export default {
    ...
    methods: {
        log() {
            const obj = {
                first_name: this.cardName,
                last_name: this.cardLastName,
                number: this.cardNumber,
                verification_value: this.cardCvv,
